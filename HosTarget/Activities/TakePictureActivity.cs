...
namespace HosTarget.Activities
{
    ...
    public class TakePictureActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            imageDirectory = new File(Android.OS.Environment.GetExternalStoragePublicDirectory(Android.OS.Environment.DirectoryPictures), "HosTarget");
        ...
        private void TakePictureButton_Click(object sender, EventArgs e)
        {
            ...
            imageFile = new File(imageDirectory, String.Format("HosTarget_{0}.jpg", Guid.NewGuid()));

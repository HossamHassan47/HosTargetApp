...
{
    public class DoneTargetsFragment : TargetBaseFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            return inflater.Inflate(Resource.Layout.DoneTargetsFragment, container, false);
        ...
        {
            targets = targetDbRepository.GetTargetsByState(TargetState.Done);

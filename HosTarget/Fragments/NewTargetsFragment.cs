...
{
    public class NewTargetsFragment : TargetBaseFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            return inflater.Inflate(Resource.Layout.NewTargetsFragment, container, false);
        ...
        {
            targets = targetDbRepository.GetTargetsByState(TargetState.New);
